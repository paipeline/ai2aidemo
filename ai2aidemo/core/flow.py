...
from ai2aidemo.core.message import Message, Question, Response, Greeting
...
class Flow:
    def __init__(self, agent1: Agent, agent2: Agent, num_turns=3):
        self.agent1 = agent1
        self.agent2 = agent2
    ...
    def _set_topics(self) -> List[str]:
        """Set and return the list of user topics."""
        topics_generator = Topics(agent1_knowledge=self.agent1.enhanced_resume, 
                                agent2_knowledge=self.agent2.enhanced_resume)
